...
from astrobase.schemas.cluster import GKECreate, GKECreateAPI, GKECreateFilter
...
class GKEApi:
    ...
    def get_gke_clusters(self, project_id: str, location: str) -> List[dict]:
    ...
    def describe_gke_cluster(
        self, location: str, project_id: str, cluster_name: str
    ) -> dict:
